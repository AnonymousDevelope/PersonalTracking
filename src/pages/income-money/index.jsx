        ...
        <div className="flex flex-col w-1/2">
          ...
          <form>
            <div className="flex flex-col mt-4  gap-3 pb-9 border-b-2 border-slate-600">
              <label htmlFor="income" className="text-sm "> Enter your income/budget
                <span className="text-red-500 text-lg align-middle"> *</span>
              </label>
              <Input required id="income" type="number" className="w-full  italic placeholder:italic" placeholder="Ex: 100" />
              <button className="btn bg-slate-700 text-white w-fit px-4 py-3 rounded-md">Set Income</button>
            </div>
          </form>
          <form>
            <div className="flex flex-col mt-4  gap-3 pb-9 border-b-2 border-slate-600">
              <label htmlFor="income-name" className="text-sm "> Transaction name
                <span className="text-red-500 text-lg align-middle"> *</span>
              </label>
              <Input required id="income-name" type="text" className="w-full  italic placeholder:italic" placeholder="Youtubdan" />
              ...
              <label htmlFor="date" className="text-sm "> Enter your income amount
                <span className="text-red-500 text-lg align-middle"> *</span>
              </label>
              <Input required id="date" type="number" className="w-full placeholder:italic" placeholder="Amount" />
              <button className="btn bg-slate-700 text-white w-fit px-4 py-3 rounded-md">Add Income</button>
            </div>
          </form>
        </div>
        <div className="flex flex-col w-1/2">
          <CardTransUI classNameParent="mt-5 max-sm:w-full max-xs:w-full gap-3 max-h-[550px] min-h-[550px] overflow-y-auto"
            ...
            <div></div>
            {
              historyData.filter(({ type }) => type === "Income").map(({ type, title, id, amount }) => (
